...
import { TCreateCategory, TReadAllCategories } from '../interfaces/categories.interface';
import { categoryRepo } from '../repositories';

export const createCategoryService = async (data: TCreateCategory): Promise<Category> => {
    return await categoryRepo.save(data);
};

export const readAllCategoriesService = async (): Promise<TReadAllCategories> => {
